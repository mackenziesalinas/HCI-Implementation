  ...
  void initState() {
    ...
    dailyActivities = [
      ...
      Activity(
        DateTime(2023, 11, 13),
        'Reading',
        DateTime(2023, 1, 11, 19, 00),
      ),
      Activity(
        DateTime(2023, 11, 16),
        'Workout class',
        DateTime(2023, 1, 11, 10, 00),
      ),
      Activity(
        DateTime(2023, 11, 18),
        'Dinner with friends',
        DateTime(2023, 1, 11, 19, 30),
      ),
      Activity(
        DateTime(2023, 11, 17),
        'Cooking class',
        DateTime(2023, 1, 11, 18, 00),
      ),
      Activity(
        DateTime(2023, 11, 18),
        'Hiking',
        DateTime(2023, 1, 11, 8, 00),
      ),
      Activity(
        DateTime(2023, 11, 17),
        'Dentist App',
            ...
            child: Column(
              children: <Widget>[
                Align(
                  ...
                  child: IconButton(
                    icon: Icon(Icons.arrow_back, size: 25, color: Colors.white), // Close icon
                    onPressed: () {
